...
<body>
	...
	<nav id="navi">
		...
		<li><a href="adminpgwater.php">Water</a></li>
...
<br/>
<br/>
  <h1 style="text-align: center;">Water Section</h1>
...
<i>
      ...
      <li><h2>Send Reading to WASA</h2></li>
            <br/>
      <br/>
      ...
      <br/>
       ...
       <div class="electricitycontent2">
        <h2 style="text-align: center;">Functions</h2>
         <button ><a href="recordReadingWater.php">Record And Send Reading to Wasa</a></button>

         
         <button ><a href="getcbillw.php">Get Client's Bill</a></button>
