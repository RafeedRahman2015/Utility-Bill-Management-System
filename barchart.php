  ...
  $year="";
   include 'connector.php';
    if(isset($_POST['year1'])){
      $year=$_POST['year'];
    echo "<script>alert('Now Choose Type of Chart');</script>";
    }
if($year!=""){
   $sql="select amount,month(date) from electricityreading where id=$uid  and year(date)='$year' order by date;";
...
$i++;
   ...
   if($i==0){
    echo "You donot have any previous record!!";
   }
}
else{
    ...
    let massPopChart = new Chart(myChart, {
      ...
      data:{
        ...
        datasets:[{
          label:'TAKA',
          data:amount,
          backgroundColor:["#7CFC00","#006400","#32CD32","##228B22","#228B22","#008000","#7CFC00","#006400","#32CD32","##228B22","#228B22","#008000"],
    ...
    let massPopChart = new Chart(myChart, {
      ...
      data:{
        ...
        datasets:[
        {
          label:'TAKA',
          data:amount,
          backgroundColor:["#7CFC00","#7FFF00","#32CD32","#00FF00","#228B22","#008000","#7CFC00","#006400","#32CD32","##228B22","#228B22","#008000"],
          borderWidth:1,
          borderColor:'#777',
          hoverBorderWidth:3,
          hoverBorderColor:'#000'
